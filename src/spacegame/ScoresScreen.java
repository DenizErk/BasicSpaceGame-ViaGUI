...
public class ScoresScreen extends GameMenu{
    static JButton menuButton;
    static StartMenu sMenu = new StartMenu();

    public ScoresScreen() throws UnsupportedAudioFileException, IOException, LineUnavailableException {
        super();
    ...
    public static void scoresScreen() {
        ...
        mainTextArea = new JTextArea("HIGH SCORE\n       " + getHighestScore());
        mainTextArea.setBounds(200, 50, 200, 80);
